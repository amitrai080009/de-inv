...
<body>
	...
	<div class="container-fluid">
		...
		<br> <br> -->
		<br> 
		<h4 style="text-align: center;">EQUIPMENT TENDER DETAIL</h4>
		<hr class="impo-bottom-border">
		<div class="tablediv">
			<table class="display" id="newsblog" class="cell-border"
				style="width: 90%">
				<thead style="background-color: #f09554; border: 2px">
					<tr>
						...
						<th style="width: 30%">Corrigendum</th>
					</tr>
				</thead>
				<tbody>
					...
					<s:if test="#tender.tender_cat == 'Equipment'">
						<tr>
							<td><%out.print(i);i++;%></td>
							<td><s:property value="tender_no" /></td>
							<td style="width: 20%;"><s:property value="title" /></td>
							<td><s:property value="tender_cat" /></td>
							<td><s:property value="tender_end" /></td>
