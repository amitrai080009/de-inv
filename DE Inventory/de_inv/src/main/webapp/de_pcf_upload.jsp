...
<title>DeepShaala PCF Upload Form</title>
...
<script>
        ...
        if (message) {
            ...
            window.location.href = '<s:url action="de_pcf_upload"/>';
        }
    </script>
<!-- Display alert message of message -->
...
<body class="nav-md">
				...
				<div class="row">
					<div class="col-md-12 col-sm-12 ">
						<div class="dashboard_graph">
							...
							<form id="myForm" action="fetchIssueDetailsPcf" method="get">
								<div class="form-row">
							...
							<!-- second from starts from here -->	
								...
								<form action="upload_pcf_action.action" method="post" enctype="multipart/form-data">
 ...
 --%>								
								...
								<button class="btn btn-primary" type="submit">UPLOAD PCF FILE</button>
							</form>
						</div>
						<br>
					</div>
