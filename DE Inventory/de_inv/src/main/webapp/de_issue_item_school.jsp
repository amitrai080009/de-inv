					...
					<div class="col-md-12 col-sm-12 ">
						<div class="dashboard_graph">
							...
							<div class="row x_title">
								<div class="col-md-6">
									<h3>
										<small>Tablet/Item Issue Form</small>
									</h3>
							...
							<form action="de_add_item.action" method="post" enctype="multipart/form-data">
								<div class="form-row">
								...
								<div class="form-row" id="form-row">
									...
									<div class="col-md-4 mb-2">
										<label for="validationServer04">STD/CLASS</label> <select name="desc"
											class="form-control" aria-label="Default select example">
								...
								<hr>
<!-- 								    <button class="btn btn-round btn-success" type="button" onclick="addFormRow()">Add Form Row</button>
 -->								
						<!-- button to generate dynamic fields -->		
								...
								<div class="form-group">
									<div class="col-md-4 mb-2">
										<input class="form-control upload-file" type="file" id="file" name="file" value="" id="" required>
									</div>
								</div>
