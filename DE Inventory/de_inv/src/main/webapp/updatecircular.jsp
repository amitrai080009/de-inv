			...
			<div class="page-container">
				...
				<div class="page-content">
					...
					<div class="content-wrapper">
						...
						<form method="post" action="update-circular"
												...
												<div class="row">
															...
															<div class="col-md-12">
																<div class="form-group">
																	<textarea class="form-control" name="title"
																		...
																		id="txtDescription" required=""><s:property
																			value="update_title" /></textarea>
																</div>
															</div>
														</div>
													</div>
													...
													<div class="col-md-12">
														<input type="hidden" name="id"
															...
															id="submit" value="Update Circular Details" />
													</div>
												</div>
											</div>
										</div>
                        ...
                        try
                        {
                            ...
                            %>
										<tr>
											...
											<td style="width: 8%">
												<form name="form" method="POST" action="update-acircular">
													<input type="hidden" name="id"
