				...
				<div class="page-content">
					...
					<div class="panel panel-flat" id="frmManageTender">
							<div class="panel-body">
								<form method="post" action="upload-vacancy"
												...
												<div class="row">
													<div class="row">
														<div class="row">
															<div class="input-field col s3">
																<input type="text" name="refno" size="100"
															...
															<div class="input-field col s3">
																<input name="validfrom" class="datepicker"
																	placeholder="Start Date (mm/dd/yyyy)" type="text"
																	autocomplete="off" required />

															</div>
															<div class="input-field col s3">
																<input name="validto" class="datepicker"
																	placeholder="End Date (mm/dd/yyyy)" type="text"
																	autocomplete="off" required />
															</div>
													...
													<div class="col-md-12" style="color: red">
														<input type="submit" name="upload" value="Upload"
															class="btn btn-primary pull-left" id="submit"> <strong><s:property
																value="vacancy.msg" /></strong>
													</div>
												</div>
											</div>
										</div>
										...
										<table class="table table-bordered" id="newsblog">
											<thead style="width: 100%; background-color: #b3d4fd">
												<tr style="width: 100%">
													...
													<th style="width: 25%">Ref. Number</th>
													<th style="width: 12%">Valid Form</th>
											...
											<tbody style="width: 100%">
												...
												<tr>
													...
													<td style="width: 13%"><s:property value="title"/></td>
													<td style="width: 25%"><s:property value="refno"/></td>
													<td style="width: 12%"><s:property value="validfrom"/></td>
													<td style="width: 12%"><s:property value="validto"/></td>
													...
													<td style="width: 8%">
														<form name="form" method="POST" action="get-tender">
															<input type="hidden" name="id"
																...
																type="button" name="submit" onsubmit=""
